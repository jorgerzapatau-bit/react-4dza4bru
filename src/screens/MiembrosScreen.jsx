        ...
        <div style={{ maxWidth: 1400, margin: "0 auto", width: "100%" }}>
          ...
          <div style={{ display: "flex", gap: 8, marginBottom: 12 }}>
            {(() => {
              ...
              return [
                { label: "Activos", val: "Activo", count: miembros.filter(m => getMembershipInfo(m.id, txs, m).estado === "Activo").length, c: "#4ade80", bg: "rgba(74,222,128," },
                { label: "Vencidos", val: "Vencido", count: miembros.filter(m => { const s = getMembershipInfo(m.id, txs, m).estado; return s === "Vencido" || s === "Sin membresía"; }).length, c: "#f87171", bg: "rgba(248,113,113," },
                { label: "Nuevos", val: "Nuevo", count: nuevosCount, c: "#38bdf8", bg: "rgba(56,189,248," },
                ...(becasCount > 0 ? [{ label: "Becas", val: "Beca", count: becasCount, c: "#fbbf24", bg: "rgba(251,191,36," }] : []),
        ...
        <div style={{ maxWidth: 1400, margin: "0 auto", width: "100%" }}>
          {(() => {
            ...
            const lista = miembros.filter(m => {
              ...
              const matchEstado =
                filtroEstado === "Todos" ||
                (filtroEstado === "Activo" && est === "Activo") ||
                (filtroEstado === "Vencido" && (est === "Vencido" || est === "Sin membresía")) ||
