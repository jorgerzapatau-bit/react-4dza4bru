          ...
          {editing ? (
            ...
            <>
              ...
              {(() => {
                ...
                const totalPagado = txMiembro
                  .filter(t => t.tipo === "ingreso")
                  .reduce((s, t) => s + Number(t.monto || 0), 0);
                const fechaInicio = m.fecha_incorporacion
                  ? new Date(m.fecha_incorporacion + "T00:00:00")
                  : null;
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 6, marginBottom: 12 }}>
                        {alertas.map((a, i) => (
                          <div key={i} style={{
                            ...
                            <span style={{ color: a.color, fontSize: 12, fontWeight: 700 }}>{a.msg}</span>
                          </div>
                        ))}
                      </div>
                    )}
